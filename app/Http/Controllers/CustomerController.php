...
class CustomerController extends Controller {
	...
	function getUpdate(Request $request, $id = null)
	{
		...
		if($row)
		{
			...
			$this->data['row'] = $this->model->getColumnTable('affiliateuser'); 
	...
	public function getShow( Request $request, $id = null)
	{
		...
		if($row)
		{
			...
			return redirect('admin/customer')->with('message','Record Not Found !')->with('status','error');					
		}
	}	
	...
	function postSave( Request $request)
	{
		...
		if ($validator->passes()) {
			...
			{
				$return = 'admin/customer/update/'.$id.'?return='.self::returnUrl();
			} else {
				$return = 'admin/customer?return='.self::returnUrl();
			}
			...
			return redirect('admin/customer/update/'.$request->input('Id'))->with('message','The following errors occurred !')->with('status','error')
	...
	public function postDelete( Request $request)
	{
		...
		if(count($request->input('ids')) >=1)
		{
			...
			// redirect
			return redirect('admin/customer?return='.self::returnUrl())
