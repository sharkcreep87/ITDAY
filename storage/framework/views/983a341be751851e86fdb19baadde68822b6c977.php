<?php echo Form::open(array('url'=>'#', 'class'=>'form-horizontal ','data-parsley-validate'=>'')); ?>

 <div class="form-group">
  <label for="ipt" class=" control-label col-md-4"> Access Token </label>
	<div class="col-md-8">
    <textarea name="access_token" rows="5" id="access_token" class="form-control input-sm" value="" required="true"><?php echo e($oauth->access_token); ?></textarea>
	</div> 
</div>  
<div class="form-group">
  <label for="ipt" class=" control-label col-md-4"> Expires In </label>
  <div class="col-md-8">
    <input name="expires_in" type="text" id="expires_in" class="form-control input-sm" value="<?php echo e($oauth->expires_in); ?>" required="true" /> 
  </div> 
</div>  
<div class="form-group">
  <label for="ipt" class=" control-label col-md-4"> Token Type </label>
  <div class="col-md-8">
    <input name="name" type="token_type" id="token_type" class="form-control input-sm" value="<?php echo e($oauth->token_type); ?>" required="true" /> 
  </div> 
</div>  
<div class="form-group">
...
<?php echo Form::close(); ?> 
<script src="<?php echo e(asset('apitoolz-assets/global/plugins/clipboardjs/clipboard.min.js')); ?>" type="text/javascript"></script>
