...
<?php $__env->startSection('formdesign'); ?>
<form action="<?php echo e(url('core/model/config/'.$row->module_id.'/formdesign')); ?>" method="post" class="form-vertical" id="doReorder" data-parsley-validate>
    ...
    <div class="col-md-4">
        ...
        <?php if($form_column == 2): ?>
        <div class="form-group ">
            <label> Columns Width : </label>
            <select class="form-control" required name="width" style="width:200px;" onchange="location.href='?block=<?php echo e($form_column); ?>&width='+this.value">
