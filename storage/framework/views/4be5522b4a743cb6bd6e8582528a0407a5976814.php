...
<link href="<?php echo e(asset('apitoolz-assets/global/plugins/jstree/dist/themes/default/style.min.css')); ?>" rel="stylesheet" type="text/css" />
...
<link href="<?php echo e(asset('apitoolz-assets/global/plugins/codemirror/addon/display/fullscreen.css')); ?>" rel="stylesheet" type="text/css" />
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-form bordered">
                <div class="portlet-body">
                    ...
                    <?php endif; ?>
	                <form action="<?php echo e(url('core/storage/file')); ?>" id="frm_editor" method="POST">
                                    ...
                                    <div class="portlet light" id="code-editor">
                                        <div class="portlet-title tabbable-line">
                                            <ul class="nav nav-tabs pull-left" id="tabs">
                                                <?php if($path): ?>
                                                <li class="active">
                                                    <a href="#tab-view" data-toggle="tab"> <?php echo e($file); ?> <i class='fa fa-close' onclick='removeTab(this,"#tab-view")'></i></a>
                                                </li>
                                                <?php endif; ?>
                                            </ul>
                                        </div>
                                        <div class="portlet-body">
                                            <div class="tab-content" id="mTab">
                                                ...
                                                <div class="tab-pane active" id="tab-view">
                                                    <input type="hidden" name="_file[]" value="<?php echo e($path); ?>">
                                                    <textarea name='content[]' rows='35' id='edt_view' class='form-control'><?php echo e($content); ?></textarea>
                                                </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
...
<script src="<?php echo e(asset('apitoolz-assets/global/plugins/jstree/dist/jstree.min.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('apitoolz-assets/global/plugins/jstree/dist/jstreetable.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('apitoolz-assets/global/plugins/codemirror/addon/display/fullscreen.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(asset('apitoolz-assets/global/plugins/codemirror/mode/clike/clike.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('apitoolz-assets/global/plugins/codemirror/mode/php/php.js')); ?>" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    var jstree = $('#divtree').jstree({
        'core' : {
            'data' : {
                'url' : '<?php echo e(url("core/storage/jstree")); ?>?operation=get_node',
                'data' : function (node) {
                    return { 'id' : node.id };
                }
            },
    ...
    .on('delete_node.jstree', function (e, data) {
        if(confirm('Are you sure you want to delete?')){
            $.get('<?php echo e(url("core/storage/jstree")); ?>?operation=delete_node', { 'id' : data.node.id })
                .fail(function () {
    ...
    .on('create_node.jstree', function (e, data) {
        $.get('<?php echo e(url("core/storage/jstree")); ?>?operation=create_node', { 'type' : data.node.type, 'id' : data.node.parent, 'text' : data.node.text })
            .done(function (d) {
    ...
    .on('rename_node.jstree', function (e, data) {
        $.get('<?php echo e(url("core/storage/jstree")); ?>?operation=rename_node', { 'id' : data.node.id, 'text' : data.text })
            .done(function (d) {
                data.instance.set_id(data.node, d.id);
            })
            .fail(function () {
    ...
    .on('move_node.jstree', function (e, data) {
        $.get('<?php echo e(url("core/storage/jstree")); ?>?operation=move_node', { 'id' : data.node.id, 'parent' : data.parent })
            .done(function (d) {
    ...
    .on('copy_node.jstree', function (e, data) {
        $.get('<?php echo e(url("core/storage/jstree")); ?>?operation=copy_node', { 'id' : data.original.id, 'parent' : data.parent })
            .done(function (d) {
                //data.instance.load_node(data.parent);
                data.instance.refresh();
            })
    ...
    .on('changed.jstree', function (e, data) {
        if(data && data.selected && data.selected.length) {
            $.get('<?php echo e(url("core/storage/jstree")); ?>?operation=get_content&id=' + data.selected.join(':'), function (d) {
    ...
    var changePerms = function() {
        ...
        _Modal('<?php echo e(url("core/storage/perms")); ?>?_file='+$file_path,'Permission for '+node[0].text);
    }
    ...
    $("#filetree").change(function(){
        ...
        $.ajax({
            url: '<?php echo e(asset("core/storage/file/upload")); ?>',  //Server script to process data
            type: 'POST',
    ...
    function addTabs(id, text, path, ext) {
        ...
        if(!tab_existed) {
            $('#loader').show();
            $.get('<?php echo e(url("core/storage/file")); ?>?_file='+path, function(data){
                $('#loader').hide();
