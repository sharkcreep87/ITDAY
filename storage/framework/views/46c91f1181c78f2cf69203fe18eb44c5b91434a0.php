        ...
        <div class="portlet light bordered">
        	<div class="portlet-title">
                ...
                <div class="grid actions">
                    ...
                    <a href="<?php echo e(url('admin/customer/update?return='.$return)); ?>" class="tips btn btn-xs green" title="Create <?php echo e($pageTitle); ?>">
                    ...
                    <?php endif; ?>
                    <a href="javascript:;" class="tips btn btn-xs yellow-gold" onclick="_Modal('<?php echo e(url('admin/customer/search?return='.$return)); ?>','Advance Search'); return false;" title="Search <?php echo e($pageTitle); ?>"><i class="fa  fa-search"></i> <span class="hidden-xs">Search</span></a>
                    <?php if($access['is_excel'] ==1): ?>
                    <a href="<?php echo e(url('admin/customer/download?return='.$return)); ?>" class="tips btn btn-xs blue" title="Download <?php echo e($pageTitle); ?>">
                        <i class="fa fa-cloud-download"></i> <span class="hidden-xs">Download</span></a>
                    <?php endif; ?>

                    <a href="<?php echo e(url('admin/customer')); ?>" class=" tips btn btn-xs btn-default" title="Clear Search"><i class="fa fa-spinner"></i> <span class="hidden-xs"> Clear</span></a>
                </div>
            </div>
            ...
            <div class="portlet-body">
                ...
                <?php echo Form::open(array('url'=>'admin/customer/delete/0?return='.$return, 'class'=>'form-horizontal' ,'id' =>'_Table' )); ?>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="<?php echo e(url('admin/customer/show/'.$row->Id.'?return='.$return)); ?>" class="tips" title="View"><i class="fa  fa-search "></i> View </a></li>
                                            <?php endif; ?> <?php if($access['is_edit'] ==1): ?>
                                            <li><a href="<?php echo e(url('admin/customer/update/'.$row->Id.'?return='.$return)); ?>" class="tips" title="Edit"><i class="fa fa-edit "></i> Edit </a></li>
                                            <?php endif; ?>
                                        </ul>
                                    </div>
                ...
                <?php else: ?>
                    <p class="text-center image_background no-result">There is no record!
                        <br />
                        <br />
                        <a href="<?php echo e(url('admin/customer/update?return='.$return)); ?>" class="btn btn-danger "><i class="icon-plus-circle2"></i> New <?php echo e($pageTitle); ?> </a>
                    </p>
                <?php endif; ?>
            </div>
        </div>
