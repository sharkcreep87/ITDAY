<form id="<?php echo e($pageModule); ?>Search">
	<table class="table search-table table-striped" id="advance-search">
		<tbody>
		<?php $__currentLoopData = $tableForm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<?php if($t['search'] =='1'): ?>
				<tr id="<?php echo e($t['field']); ?>" class="fieldsearch">
					<td><?php echo $t['label']; ?> </td>
					<td > 
					<select id="<?php echo e($t['field']); ?>_operate" class="form-control oper" name="operate" onchange="changeOperate(this.value , '<?php echo e($t['field']); ?>')">
					...
					<td id="field_<?php echo e($t['field']); ?>"><?php echo SiteHelpers::transForm($t['field'] , $tableForm); ?></td>
		...
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			<tr>
				<td></td>
				<td colspan="2">
					<button type="button" name="search" class="doSearch btn green"> Build </button>
