...
@endforeach
		<tr>
			<td></td>
			<td colspan="2">
				<button type="button" name="search" class="doSearch btn btn-success"> Build </button>
				<button type="button" data-dismiss="modal" aria-hidden="true" name="search" class="doSearch btn red"> Cancel </button>
			</td>
		</tr>
	</tbody>     
	</table>
