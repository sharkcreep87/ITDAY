...
<div class="page-content">
    ...
    <div class="page-content-wrapper m-t">
        ...
        {!! Form::open(array('url'=>'admin/test/save?return='.$return, 'class'=>'form-horizontal','files' => true , 'data-parsley-validate'=>'')) !!} 
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                @endif
                <div class="actions">
                    <a href="{{ url('admin/test?return='.$return) }}" class="tips btn btn-xs btn-default" title="Back"><i class="fa  fa-arrow-left"></i></a>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="form-actions">
                        <div class="col-md-offset-4 col-md-8">
                            ...
                            <button type="button" onclick="location.href='{{ URL::to('admin/test?return='.$return) }}' " class="btn btn-default"><i class="fa fa-close "></i> Cancel </button>
                        </div>
