...
<head>
        ...
        <link href="{{ asset('apitoolz-assets/css/login.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <h1 class="bold font-white"><img src="{{ asset('uploads/logo.svg') }}"> API <span class="font-green">Toolz</span></h1>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
